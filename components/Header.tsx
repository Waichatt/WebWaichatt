      ...
      <div className="container mx-auto px-4 py-4 select-none">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            <Button className="hidden md:flex bg-gradient-to-r from-[#268656] to-[#1f6b4a] hover:from-[#1f6b4a] hover:to-[#268656] text-white shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-105 animate-pulse-glow">
        ...
        {isMenuOpen && (
          <div
            className={`md:hidden mt-4 pb-4 border-t animate-slide-down ${
              isInHeroSection 
                ? "border-white/20" 
                : "border-white/20 bg-white/5 backdrop-blur-sm rounded-lg"
            }`}
          >
